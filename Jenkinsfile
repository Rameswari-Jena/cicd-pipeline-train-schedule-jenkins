pipeline{
    ...
    checkout([$class: 'GitSCM', branches: [[name: 'main']],userRemoteConfigs: [[credentialsId: 'jkey-for-git', url: 'https://github.com/Rameswari-Jena/cicd-pipeline-train-schedule-jenkins']]])
    parameters ([
